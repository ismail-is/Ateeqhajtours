...
const packagesData = [
  {
    ...
    price: "₹ 4,75,000",
    features: ["Economy Flight", "Full Board Meals", "3 Star Hotel", "Private Transport"]
  },
  {
    id: 2,
    type: "DELUXE",
  ...
  },
  {
    ...
    price: "₹ 7,25,000",
    features: ["Direct Flight", "Full Board Meals", "5 Star Hotel", "Private Transport"]
  },
  {
    id: 4,
    type: "VIP",
      ...
      <section className="relative pt-24 pb-12 bg-navy-900 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 pt-8 lg:pt-12">
          ...
          <div className="flex items-center gap-2 text-[11px] text-white/60 mb-6 font-medium">
            ...
            <span className="text-white">Haj Packages</span>
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-end gap-10">
            ...
            <div className="max-w-xl">
              <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-playfair font-bold text-white leading-tight mb-4">
                Haj <span className="text-islamic-green">Packages</span>
              </h1>
              <p className="text-white/80 text-sm md:text-[15px] leading-relaxed max-w-md">
                Choose from our wide range of Haj packages designed for a comfortable, safe and spiritually uplifting journey.
              </p>
            </div>
